...
@section('content')
    ...
    <div class="content-container">
        ...
        <i><h3 class="text-primary">Add your Concert Event</h3></i>
        ...
        <form method="POST" action="{{ route('admin.store-concert') }}" class="m-3" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div id="map" style="height:300px; width: 80%;" class="my-4"></div>
