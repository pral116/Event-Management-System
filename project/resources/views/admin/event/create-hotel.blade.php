...
@section('content')
    ...
    <div class="content-container">
        <div class="container-fluid">
            ...
            <i><h3 class="text-primary">Add your Hotel Event</h3></i>
            ...
            <form method="POST" action="{{ route('admin.store-hotel') }}" class="m-3" enctype="multipart/form-data" >
                @csrf
                <div>
                ...
                <div class="mt-3">
                    ...
                    <input type="file" name="image" class="block shadow-sm w-40 italic" accept="image/png, image/jpeg">
                </div>
